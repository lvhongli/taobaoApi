...
- (NSInteger)numberOfViewsInPhotoGallery:(UIPhotoGalleryView *)photoGallery {
    // Abstract method
    return [self.networkGalleryArray count];
}
...
- (NSURL*)photoGallery:(UIPhotoGalleryView *)photoGallery remoteImageURLAtIndex:(NSInteger)index {
    return [self.networkGalleryArray objectAtIndex:index];;
}
...
- (void)setupTopBar {
    ...
    UIBarButtonItem *btnDone = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:
        UIBarButtonSystemItemStop target:self action:@selector(btnDonePressed)];
    UIBarButtonItem *btnDetail = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemAction target:self action:@selector(btnDetailPressed)];
    
    UIBarButtonItem *flexibleSpace = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemFlexibleSpace target:self action:nil];

    [topViewBar setItems:@[btnDone, flexibleSpace, btnDetail] animated:YES];
